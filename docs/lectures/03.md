...
# Hero section
title: Full Cycle Deep Learning
...
We will see how to manage a Deep Learning project. We will go from the early project idea to the maintenance of the associated Deep Learning product.

Most of this knowledge can be acquired through years of experience working and leading Deep Learning projects in research or in the industry.

We will use as an illustration: developing a door lock that unlocks itself when it identifies your face through a camera. To achieve this task, you need to store a reference picture of yourself. You will have to train a Neural Network to tell whether two input images are from the same person, ie you. This is a binary classification task. If the images are of the same person, the system should open the door.
...
{% include image.html description="" image="lecture/3/project_selection.jpg" caption="false"%}
...
{% include image.html description="" image="lecture/3/data_acquisition.jpg" caption="false"%}
...
{% include image.html description="" image="lecture/3/model_design.jpg" caption="false"%}
...
{% include image.html description="" image="lecture/3/model_training.jpg" caption="false"%}
...
{% include image.html description="" image="lecture/3/model_testing.jpg" caption="false"%}
...
{% include image.html description="" image="lecture/3/deployment.jpg" caption="false"%}
...
{% include image.html description="" image="lecture/3/maintenance.jpg" caption="false"%}
